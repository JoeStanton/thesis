...
\begin{enumerate}
  \item Testing Framework
    ...
    \end{enumerate}
  \item System Visualisation and Monitoring
    \begin{enumerate}
      ...
      \item The tool should provide a way to visualise changes happening within the system.
      \item The tool should calculate the degree of reliability of each host, service and component.
      \item The tool should send Email notifications to users.
      \item The tool should send SMS notifications to users.
    \end{enumerate}
\end{enumerate}
